...
export const WXDAI_BUSD = "0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16";

export const DAR_XDAI = "0x062f88e2b4896e823ac78ac314468c29eec4186d";
...
export let TRACKED_TOKEN_BUSD_PAIRS: string[] = [
  "0x804678fa97d91b974ec2af3c843270886528a9e6", // PANDA/BUSD
];

export function getXdaiPriceInUSD(): BigDecimal {
  // Bind WXDAI/BUSD contract to query the pair.
  let pairContract = Pair.bind(Address.fromString(WXDAI_BUSD));

  // Fail-safe call to get XDAI price as BUSD.
