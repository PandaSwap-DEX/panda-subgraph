...
export function getOrCreateMasterChef(block: ethereum.Block): MasterChef {
  ...
  if (masterChef === null) {
    ...
    masterChef.pandaRateToBurn = BigInt.fromString("750000000000");
    masterChef.pandaRateToRegularFarm = BigInt.fromString("100000000000");
    masterChef.pandaRateToSpecialFarm = BigInt.fromString("150000000000");
