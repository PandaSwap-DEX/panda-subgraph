...
import { PandaFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = PandaFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new PandaFactory(FACTORY_ADDRESS);
  ...
  pair.trackedReserveXDAI = ZERO_BD;
